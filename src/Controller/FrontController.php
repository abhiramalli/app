...
class FrontController extends AbstractController
{
     ...
     */
    public function videoList($id,CategoryTreeFrontPage $categoryTreeFrontPage): Response
    {

        $categoryTreeFrontPage->getCategoryListAndParent($id);

        return $this->render('front/video_list.html.twig',['subcategories'=>$categoryTreeFrontPage]);
    }
